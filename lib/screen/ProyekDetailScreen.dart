...
class ProyekDetailScreen extends StatelessWidget {
  ProyekDetailScreen({Key key}) : super(key: key);
                  ...
                  Container(
                    ...
                    child: NestedScrollView(
                      headerSliverBuilder: (BuildContext context, bool innerBoxIsScrolled) {
                        return <Widget>[
                          SliverAppBar(
                            ...
                            flexibleSpace: WidgetFlexibleSpaceDetailProduct(blocProyek: blocProyek, hashCode: hashCode),
                          ),
                        ];
                      },
                      body: SingleChildScrollView(
                        child: Column(
                          children: <Widget>[
                            WidgetHeaderDetailProduct(blocProyek: blocProyek, blocOrder: blocOrder, IDR: IDR),
                            WidgetInformasiDetailProyek(blocProyek: blocProyek),
                            WidgetDeskripsiDetailProyek(blocProyek: blocProyek),
                            WidgetUlasanPembeli(blocProyek: blocProyek),
                          ],
                        ),
                      ),
                    ),
...
//                           Navigator.
  ...
  Widget _buttonBuy(context) {
    ...
    return Container(
      child: InkWell(
        onTap: () {
          blocProyek.detailProduct[0].stok == '0' ? '' : _showDialog(context);
        },
        child: Center(
            child: Text(
          blocProyek.detailProduct[0].stok == '0' ? 'Stok tidak tersedia' : 'Beli',
          style: TextStyle(color: Colors.white),
        )),
      ),
      height: 40,
      width: MediaQuery.of(context).size.width * 0.7,
      decoration: BoxDecoration(color: blocProyek.detailProduct[0].stok == '0' ? Colors.grey[400] : Colors.cyan, borderRadius: BorderRadius.circular(20)),
    );
  }
...
//                    Divider(),
                                  ...
                                  title: Row(
                                    ...
                                    children: [
                                      Container(
                                        ...
                                        child: Image.network('https://m-bangun.com/api-v2/assets/toko/' + blocProyek.detailProduct[0].foto, width: 50, height: 80,
                                          ...
                                          Container(
                                            ...
                                            child: Row(
                                              ...
                                              children: [
                                                ...
                                                Text(Money.fromInt((int.parse(blocProyek.detailProduct[0].harga)), IDR).toString(),
                                          ...
                                          Container(
                                            ...
                                            child: Row(
                                              ...
                                              children: [
                                                ...
                                                Text(
                                                  Money.fromInt((int.parse(blocProyek.detailProduct[0].harga) * blocOrder.jumlah), IDR).toString(),
                                      ...
                                      Container(
                                        ...
                                        child: Theme(
                                          ...
                                          child: blocProyek.detailProduct[0].stok == '1'
                                              ? Text(
                                            '1',
                                            ...
                                            minValue: 1,
                                            maxValue: int.parse(blocProyek.detailProduct[0].stok),
                                            onChanged: (value) {
                      ...
                      blocOrder.jumlah < int.parse(blocProyek.detailProduct[0].minimalPesanan)
                        ...
                        onPressed: () async {
                          ...
                          map["id_Proyek"] = blocProyek.detailProduct[0].id;
                          map["id_user_login"] = blocAuth.idUser;
                          map["jumlah"] = blocOrder.jumlah.toString();
                          map["harga"] = blocProyek.detailProduct[0].harga;
                          map["subtotal"] = (int.parse(blocProyek.detailProduct[0].harga) * blocOrder.jumlah).toString();
                          map["id_toko"] = blocProyek.detailProduct[0].idToko;
                          map["jenis_ongkir"] = blocProyek.detailProduct[0].jenisOngkir;
                          map["catatan"] = blocOrder.catatan;
                          var result = blocProyek.getCurrentStokProyek({'id': blocProyek.detailProduct[0].id.toString()});
                          result.then((value) async {
                            ...
                            if (value['stok'] != '0') {
                              ...
                              _btnController.reset();
                              Navigator.pop(context);
                              blocProyek.getDetailProductByParam({'id': blocProyek.detailProduct[0].id.toString()});
                            }
                          });
                        },
                      )
