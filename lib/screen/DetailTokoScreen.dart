...
class _DetailTokoScreenState extends State<DetailTokoScreen> {
  ...
  setColor() async {
    var a = _updatePaletteGenerator(region, baseURL + '/'+ pathUrl +'/assets/toko/' + widget.image);
    a.then((value) {
      setState(() {
        bannerColor = value;
      });
          ...
          : RefreshIndicator(
              ...
              child: CardSliverAppBar(
                ...
                background: Image.network(
                  baseURLMobile + "/"+ pathUrl +"/assets/toko/" + blocProduk.detailStore[0].fotoSampul,
                  fit: BoxFit.cover,
                ...
                card: NetworkImage(
                  baseURL + '/'+ pathUrl +'/assets/toko/' + blocProduk.detailStore[0].foto,
                ),
                backButton: true,
